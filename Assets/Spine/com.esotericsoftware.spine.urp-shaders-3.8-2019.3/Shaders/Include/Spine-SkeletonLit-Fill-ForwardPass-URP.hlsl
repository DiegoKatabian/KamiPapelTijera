#ifndef SKELETONLIT_FILL_FORWARD_PASS_URP_INCLUDED
#define SKELETONLIT_FILL_FORWARD_PASS_URP_INCLUDED
...
// Fill color properties - must be declared in the shader that includes this file
// float4 _FillColor;
// float _FillPhase;
...
#endif
	half4 litColor = tex * i.color;

	// Apply fill overlay: interpolate between lit color and fill color based on _FillPhase
	half3 finalColor = lerp(litColor.rgb, (_FillColor.rgb * litColor.a), _FillPhase);
	return half4(finalColor, litColor.a);
}
